...
import type { PriorityBreakdownV2, DashboardPeriod } from "@/actions/dashboard";
...
export function PriorityChart({ data, currency = "BRL", period }: PriorityChartProps) {
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base">
            Distribuição por Prioridade{period ? ` (${MONTH_LABELS[period.month]}/${period.year})` : ""}
          </CardTitle>
        </CardHeader>
